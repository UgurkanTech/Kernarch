...
void init_gdt() {
    ...
    gdt_set_gate(3, 0x1000000, 0xFFFFFFFF, 0xFA, 0xCF); // User mode code segment - 0xFA (present, executable, readable, DPL = 3)
    // Base: 0x1000000 (16MB), Limit: 0xFFFFFFFF (4096MB)
    gdt_set_gate(4, 0x1000000, 0xFFFFFFFF, 0xF2, 0xCF); // User mode data segment - 0xF2 (present, writable, DPL = 3)
